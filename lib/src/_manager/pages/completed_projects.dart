...
class MgrCompletedProjects extends StatefulWidget {
  const MgrCompletedProjects({
    Key? key,
  }) : super(key: key);

  @override
  _MgrCompletedProjectsState createState() => _MgrCompletedProjectsState();
}

class _MgrCompletedProjectsState extends State<MgrCompletedProjects> {
